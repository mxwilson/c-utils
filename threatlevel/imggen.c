...
snprintf(embuff, sizeof embuff, "convert -size 450X300 -background '%s' -quality 100 -fill white -gravity north -font FreeSans-Bold -pointsize 30 caption:\"%s\" -trim -font DejaVu-Sans-Mono -pointsize 14 caption:\"THREAT LEVEL: %d\n%s\n\n%s\" -append -border 2 \'%s%s-%d.jpg\'", thecolor, header, threatlevel, theitems[a], theitems2[a], imgsavedir, timebuf, a);
